...
import kg.evoschool.Api.AudioList;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditProfileActivity.Name = "";
        EditProfileActivity.settings = getSharedPreferences(EditProfileActivity.prefsFiles, EditProfileActivity.MODE_PRIVATE);
    }
...
//    }
    ...
    public void onStart() {
        ...
        EditProfileActivity.Name = EditProfileActivity.settings.getString(EditProfileActivity.prefName, "Имя");
        EditProfileActivity.Surname = EditProfileActivity.settings.getString(EditProfileActivity.prefSurname, "Фамилия");
        EditProfileActivity.City = EditProfileActivity.settings.getString(EditProfileActivity.prefCity, "Город");
        EditProfileActivity.Country = EditProfileActivity.settings.getString(EditProfileActivity.prefCountry, "Страна");
        String email = EditProfileActivity.settings.getString(EditProfileActivity.prefEmail, "Почта");
